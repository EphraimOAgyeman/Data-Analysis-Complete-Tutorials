...
The other way of loading or gathering data is visually. If the data is on the internet, on a website, simply download it and manually upload it the jupyter platform. likewise if the data is on the computer, upload it to the jupyter platform using the file upload option at the start of
